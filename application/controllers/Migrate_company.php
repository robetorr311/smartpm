...
class Migrate_company extends CI_Controller
{
    ...
    public function do_migration($db, $version = null)
    {
        dbSelect('smartpm_' . $db);
    ...
    public function undo_migration($db, $version = null)
    {
        dbSelect('smartpm_' . $db);
    ...
    public function reset_migration($db)
    {
        dbSelect('smartpm_' . $db);
