...
<div id="edit-section" class="container-fluid">
    <div class="row page-header-buttons">
        <div class="col-md-12 max-1000-form-container">
            ...
            <a href="<?= base_url('group/' . $group->id . '/delete') ?>" data-method="POST" class="btn btn-danger btn-fill show-edit-toggler pull-right"><i class="fa fa-trash-o" aria-hidden="true"></i>&nbsp; Delete</a>
        </div>
    </div>
    <div class="row">
        <div class="col-md-12 max-1000-form-container">
            <div class="card">
                ...
                <div class="content">
                    ...
                    <?= form_open('group/' . $group->id . '/update', array('id' => 'group_edit', 'method' => 'post', 'novalidate' => true)) ?>

                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                <label>Group Name<span class="red-mark">*</span></label>
                                <input class="form-control" placeholder="Group Name" name="name" value="<?= $group->name ?>" type="text">
                            </div>
                        </div>
                    </div>
