...
<body>
	...
	<?= form_open('create-token-verified-password/' . $token, ['method' => 'post']) ?>
	<h2 style="font-size: 16px;text-align: center;margin-bottom: 20px;">Create Password</h2>
	...
	<div class="input-group">
		<label>Confirm Password<span class="red-mark">*</span></label>
