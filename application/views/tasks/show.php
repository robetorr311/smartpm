...
<div id="edit-section" class="container-fluid">
    <div class="row page-header-buttons">
        <div class="col-md-12">
            ...
            <a href="<?= base_url('task/' . $task->id . '/delete') ?>" data-method="POST" class="btn btn-danger btn-fill show-edit-toggler"><i class="fa fa-trash-o" aria-hidden="true"></i>&nbsp; Delete</a>
        </div>
    </div>
    <div class="row">
