...
<div id="show-section" class="container-fluid show-edit-visible">
    ...
    <div class="row">
        <div class="col-md-8">
            ...
            <div class="row">
                <div class="col-md-12">
                    <a href="<?= base_url('lead/financial-job/' . $job->id . '/move-next-stage') ?>" class="btn btn-info btn-fill full-width  lead-move-btn" data-method="POST">Move to Production&nbsp;<i class="pe-7s-angle-right"></i></a>
                </div>
            </div>
        </div>
        <div class="col-md-4">
...
<div id="edit-section" class="container-fluid">
    ...
    <div class="row">
        <div class="col-md-8">
            ...
            <div class="card">
                <?= form_open('lead/financial-job/' . $job->id . '/updatestatus', array('method' => 'post')) ?>
                <div class="header">
                    <h4 class="title" style="float: left;">Contract Status</h4>
                    <span class="status">
                        <?= LeadModel::statusToStr($job->status) ?>
