...
<div id="show-section" class="container-fluid show-edit-visible">
    <div class="row page-header-buttons">
        ...
        <div class="col-md-4 text-right">
            <a <?= $prev_lead ? 'href="' . base_url('lead/closed-job/' . $prev_lead->id) . '"' : '' ?> class="<?= $prev_lead ? 'btn btn-info btn-fill' : 'btn btn-default btn-fill' ?>"><i class="fa fa-angle-double-left" aria-hidden="true"></i>&nbsp; Prev Lead</a>
            <a <?= $next_lead ? 'href="' . base_url('lead/closed-job/' . $next_lead->id) . '"' : '' ?> class="<?= $next_lead ? 'btn btn-info btn-fill' : 'btn btn-default btn-fill' ?>">Next Lead &nbsp;<i class="fa fa-angle-double-right" aria-hidden="true"></i></a>
        </div>
    </div>
    <div class="row">
        <div class="col-md-8">
                ...
                <div class="footer">
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            <a href="<?= base_url('lead/closed-job/' . $job->id . '/estimates'); ?>" class="btn btn-fill">Estimates</a>
                            <a href="<?= base_url('lead/closed-job/' . $job->id . '/invoices'); ?>" class="btn btn-fill">Invoices</a>
                            <a href="<?= base_url('lead/closed-job/' . $job->id . '/client-notices'); ?>" class="btn btn-fill">Client Notice</a>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="row">
        <div class="col-md-8">
            ...
            <div class="card">
                ...
                <?= form_open('lead/closed-job/' . $job->id . '/updatestatus', array('id' => 'lead_edit_status', 'method' => 'post')) ?>
                <div class="header">
