    ...
    <div class="row">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="footer">
                    <a href="<?= base_url('lead/completed-job/' . $job->id . '/photos') ?>" class="btn btn-success btn-fill">Photos</a>
                    <a href="<?= base_url('lead/completed-job/' . $job->id . '/reports') ?>" class="btn btn-danger btn-fill">All Report</a>
                    <a href="" class="btn btn-success btn-fill">Create Estimate</a>
                    <a href="<?= base_url('lead/completed-job/' . $job->id . '/docs') ?>" class="btn btn-danger btn-fill">Docs</a>
                    <a href="<?= base_url('lead/completed-job/' . $job->id . '/notes') ?>" class="btn btn-success btn-fill">Notes</a>
                </div>
            </div>
        </div>
        <div class="col-md-4">
