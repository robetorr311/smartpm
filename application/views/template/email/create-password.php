              ...
              <tr>
                <td style="border-collapse: collapse; mso-line-height-rule: exactly; padding: 15px;" class="em_padd" valign="top" bgcolor="#FFA500" align="center">
                  <table width="100%" cellspacing="0" cellpadding="0" border="0" align="center" style="border-collapse: collapse; mso-table-lspace: 0px; mso-table-rspace: 0px;">
                    <tbody>
                      <tr>
                        <td valign="top" align="center" style="border-collapse: collapse; mso-line-height-rule: exactly;"><img class="em_img" alt="logo" style="display: block; font-family: Arial, sans-serif; font-size: 30px; line-height: 34px; color: #000000; max-width: 700px; border: 0; outline: none;" src="<?= base_url('assets/' . $logoUrl) ?>" width="150" border="0"></td>
                      </tr>
                    </tbody>
                  </table>
                </td>
              ...
              <tr>
                <td style="border-collapse: collapse; mso-line-height-rule: exactly; padding: 35px 35px 30px;" class="em_padd" valign="top" bgcolor="#ffffff" align="center">
                  <table width="100%" cellspacing="0" cellpadding="0" border="0" align="center" style="border-collapse: collapse; mso-table-lspace: 0px; mso-table-rspace: 0px;">
                    <tbody>
                      <tr>
                        <td style="border-collapse: collapse; mso-line-height-rule: exactly; font-family: 'Open Sans', Arial, sans-serif; font-size: 16px; line-height: 20px; color: #333333;" valign="top" align="left"><p>You can create your password by visiting to the url given below.</p><p><a href="<?= base_url('create-password/' . $token) ?>"><?= base_url('create-password/' . $token) ?></a></p></td>
                      </tr>
                    </tbody>
                  </table>
                </td>
