              ...
              <tr>
                <td style="border-collapse: collapse; mso-line-height-rule: exactly; padding: 35px 35px 30px;" class="em_padd" valign="top" bgcolor="#ffffff" align="center">
                  <table width="100%" cellspacing="0" cellpadding="0" border="0" align="center" style="border-collapse: collapse; mso-table-lspace: 0px; mso-table-rspace: 0px;">
                    <tbody>
                      <tr>
                        <td style="border-collapse: collapse; mso-line-height-rule: exactly; font-family: 'Open Sans', Arial, sans-serif; font-size: 16px; line-height: 30px; color: #333333;" valign="top" align="center">This is a sample email which shall be accommodated in a single paragraph</td>
                      </tr>
                      <tr>
                        <td style="border-collapse: collapse; mso-line-height-rule: exactly; font-size: 0px; line-height: 0px; height: 15px;" height="15">&nbsp;</td>
                      </tr>
                      <tr>
                      ...
                      <tr>
                        <td class="em_h20" style="border-collapse: collapse; mso-line-height-rule: exactly; font-size: 0px; line-height: 0px; height: 25px;" height="25">&nbsp;</td>
                      </tr>
                      <tr>
                        <td style="border-collapse: collapse; mso-line-height-rule: exactly; font-family: 'Open Sans', Arial, sans-serif; font-size: 18px; line-height: 22px; color: #333333; text-transform: uppercase; letter-spacing: 2px; padding-bottom: 12px;" valign="top" align="center"> Lorem Ipsum is simply dummy text of the printing and typesetting industry</td>
                      </tr>
                      <tr>
                        <td class="em_h20" style="border-collapse: collapse; mso-line-height-rule: exactly; font-size: 0px; line-height: 0px; height: 25px;" height="25">&nbsp;</td>
                      </tr>
                      <tr>
                        <td style="border-collapse: collapse; mso-line-height-rule: exactly; font-family: 'Open Sans', Arial, sans-serif; padding-bottom: 12px;" align="center">
                          <a href="#" target="_blank" style="border-collapse: collapse; mso-line-height-rule: exactly; color: #fff; background: #244055; text-decoration: none; padding: 5px 15px;">Button</a>
                        </td>
                      </tr>
                    </tbody>
                  </table>
