             ...
             // $jobid=$jobs->job_id;
              ?>  
                <tr class="tr<?php echo $jobs->id ?>">
                  ...
                  <a href="<?php echo base_url();?>report/<?php echo $jobs->id ?>/pdf/<?php echo $jobs->job_id ?>" target="_blank" class="btn btn-danger btn-right btn-fill">view</a>
                      ...
                      <?php endforeach; ?>
            <?php else : ?>
               <tr><td colspan="3"><p class="mb-15">  No Record Found!</p></td></tr>
            <?php endif; ?>
                                ...
                                <div class="footer" style="margin-bottom: 10px;">
                                    ...
                                    <hr>
<a href="<?php echo base_url('report/'.$jobid.'/create');?>" target="_blank" class="btn btn-danger pull-right" style="margin:5px 10px 10px 0;">Genrate New Report</a> </div>
                            </div>
                        </div>
                    </div>
             </div>
