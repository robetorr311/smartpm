<div class="container-fluid">
	<div class="row">
		...
		</div> <?php echo form_open('report/'.$jobid.'/save',array('method'=>'post','id'=>'report-form'));?>
		<div class=" col-md-2">
...
<?php echo form_close(); ?>    
    	...
    	<div class="arrow-div" style="display:none">
			...
			<tr >
				...
				<td><img src="<?php echo base_url(); ?>assets/img/darrow-black.png" alt="darrow-black" style="color:black" class="closeFancybox"/></td>
				<td><img src="<?php echo base_url(); ?>assets/img/circle-black.png" alt="circle-black" class="closeFancybox"/></td>
				<td><img src="<?php echo base_url(); ?>assets/img/highlight-black.png" alt="highlight" style="color:rgba(0,0,0,0.5)" class="closeFancybox"/></td>
				<td><img src="<?php echo base_url(); ?>assets/img/rect-black.png" alt="rect" style="color:black" class="closeFancybox"/></td>
			...
			<td><i class="fa fa-long-arrow-left fa-stack-2x closeFancybox" alt="long-arrow-left" style="color:green" area-hidden="true" ></i></td>
				...
				<td><img src="<?php echo base_url(); ?>assets/img/darrow-green.png" alt="darrow-green" style="color:green"  class="closeFancybox"/></td>
				<td><img src="<?php echo base_url(); ?>assets/img/circle-green.png" alt="circle-green" class="closeFancybox"/></td>
				<td><img src="<?php echo base_url(); ?>assets/img/highlight-green.png" alt="highlight" style="color:rgba(0,255,0,0.5)" class="closeFancybox"/></td>
				<td><img src="<?php echo base_url(); ?>assets/img/rect-green.png" alt="rect" style="color:green" class="closeFancybox"/></td>
			...
			<tr>
				...
				<td><img src="<?php echo base_url(); ?>assets/img/darrow-red.png" alt="darrow-red" style="color:red" class="closeFancybox"/></td>
				<td><img src="<?php echo base_url(); ?>assets/img/circle-red.png" alt="circle-red" class="closeFancybox"/></td>
				<td><img src="<?php echo base_url(); ?>assets/img/highlight-red.png" alt="highlight" style="color:rgba(255,0,0,0.4)" class="closeFancybox"/></td>
				<td><img src="<?php echo base_url(); ?>assets/img/rect-red.png" alt="rect" style="color:red" class="closeFancybox"/></td>
			...
			<tr>
				...
				<td><img src="<?php echo base_url(); ?>assets/img/darrow-yellow.png" alt="darrow-yellow" style="color:yellow" class="closeFancybox"/></td>
				<td><img src="<?php echo base_url(); ?>assets/img/circle-yellow.png" alt="circle-yellow" class="closeFancybox"/></td>
				<td><img src="<?php echo base_url(); ?>assets/img/highlight.png" alt="highlight" style="color:rgba(255,255,0,0.5)" class="closeFancybox"/></td>
				<td><img src="<?php echo base_url(); ?>assets/img/rect.png" alt="rect" style="color:yellow" class="closeFancybox"/></td>
		...
		<?php 
			...
			<div class="image-div">
			<input type="checkbox" name="img" value="<?php echo $photo->image_name; ?>">
			<img src="<?php echo base_url(); ?>assets/job_photo/<?php echo $photo->image_name; ?>" />
			</div>
	<?php   endforeach;
...
handles: 'e, w'
			...
			var circle=$('<div>').attr('class','circle circle'+count).html('<span>#'+count+'</span><img src="<?php echo base_url(); ?>assets/img/'+item+'.png" id="circle'+count+'"  /><i class="fa fa-times" id="textarea-'+count+'" aria-hidden="true"></i>');
