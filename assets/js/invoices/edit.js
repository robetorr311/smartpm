var form = document.querySelector('form#invoice_edit');
var aliases = {
    date: 'Date',
    client_id: 'Client',
    item: 'Item',
...
$(document).ready(function () {
    $('form#invoice_edit #client_id').select2({
        width: '100%'
    });

    $('form#invoice_edit').on('click', '.duplicate-container.items-container .duplicate-buttons span#add', function () {
        var index = 0;
    ...
    $('form#invoice_edit').on('click', '.duplicate-container.items-container .duplicate-buttons span#remove', function () {
