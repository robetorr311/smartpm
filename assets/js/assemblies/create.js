var form = document.querySelector('form#assembly_create');
var aliases = {
    name: 'Name',
    items: 'Item'
};
...
$(document).ready(function () {
    ...
    $('form#assembly_create select').select2({
        width: '100%'
    });

    $('form#assembly_create').on('change', '.description-container select', function () {
        var selectEl = $(this);
    ...
    $('form#assembly_create').on('click', '.duplicate-container.description-container .duplicate-buttons span#add', function () {
        var index = 0;
    ...
    $('form#assembly_create').on('click', '.duplicate-container.description-container .duplicate-buttons span#remove', function () {
